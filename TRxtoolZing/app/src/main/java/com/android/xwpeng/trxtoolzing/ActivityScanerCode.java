...
import com.android.xwpeng.trxtoolzing.scaner.CameraManager;
import com.android.xwpeng.trxtoolzing.scaner.OnRxScanerListener;
import com.android.xwpeng.trxtoolzing.scaner.PlanarYUVLuminanceSource;
import com.android.xwpeng.trxtoolzing.scaner.decoding.InactivityTimer;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                // 开始对图像资源解码
                Result rawResult = Util.decodeFromPhoto(photo);
                if (rawResult != null) {
                 //扫描成功
                    Toast.makeText(this, "图片识别."+  rawResult.getText(), Toast.LENGTH_SHORT).show();
                } else {
